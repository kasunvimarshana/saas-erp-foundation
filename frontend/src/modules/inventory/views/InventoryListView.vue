<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-3xl font-bold text-secondary-900">{{ $t('inventory.title') }}</h1>
    ...
    <BaseModal v-model="showCreateModal" :title="$t('inventory.create')">
...
const viewDetail = (id) => {
  router.push({ name: 'inventoryDetail', params: { id } })
}
